...
public sealed class LinqExercises
{
    ...
    {
        return Data.UniversityData.Students
    ...
    {
        var course = Data.UniversityData.Courses
    ...
    {
        bool exists = Data.UniversityData.Enrollments.Any(e => !e.IsActive);
    ...
    {
        bool allHaveDept = Data.UniversityData.Lecturers.All(l => !string.IsNullOrEmpty(l.Department));
        return new[] { allHaveDept.ToString() };
    }
    ...
    {
        int count = Data.UniversityData.Enrollments.Count(e => e.IsActive);
    ...
    {
        return Data.UniversityData.Enrollments
    ...
    {
        return Data.UniversityData.Courses
            .OrderBy(c => c.Title)
            .Skip(2)
            .Take(2)
    ...
    {
        return Data.UniversityData.Students
            .Join(Data.UniversityData.Enrollments,
                s => s.Id,
                e => e.StudentId,
    ...
    {
        return Data.UniversityData.Enrollments
            .Join(Data.UniversityData.Students, e => e.StudentId, s => s.Id, (e, s) => new { e, s })
            .Join(Data.UniversityData.Courses, es => es.e.CourseId, c => c.Id,
    ...
    {
        return Data.UniversityData.Enrollments
            .Join(Data.UniversityData.Courses, e => e.CourseId, c => c.Id, (e, c) => c.Title)
            .GroupBy(title => title)
    ...
    public IEnumerable<string> Task14_AverageGradePerCourse()
    {
        return Data.UniversityData.Enrollments
            ...
            .Join(Data.UniversityData.Courses, e => e.CourseId, c => c.Id, (e, c) => new { c.Title, e.FinalGrade })
            .GroupBy(x => x.Title)
    ...
    {
        return Data.UniversityData.Lecturers
            .GroupJoin(Data.UniversityData.Courses,
                l => l.Id,
                c => c.LecturerId,
    ...
    {
        return Data.UniversityData.Students
            .Join(Data.UniversityData.Enrollments.Where(e => e.FinalGrade != null),
                s => s.Id,
                e => e.StudentId,
                (s, e) => new { s.FirstName, s.LastName, e.FinalGrade })
            .GroupBy(x => new { x.FirstName, x.LastName })
            .Select(g => $"{g.Key.FirstName} {g.Key.LastName} {g.Max(x => x.FinalGrade)}");
    }
    ...
    {
        return Data.UniversityData.Students
            .Join(Data.UniversityData.Enrollments.Where(e => e.IsActive),
                s => s.Id,
                e => e.StudentId,
    ...
    public IEnumerable<string> Challenge02_AprilCoursesWithoutFinalGrades()
    {
        return Data.UniversityData.Courses
            ...
            .Join(Data.UniversityData.Enrollments, c => c.Id, e => e.CourseId, (c, e) => new { c.Title, e.FinalGrade })
            .GroupBy(x => x.Title)
            .Where(g => g.All(x => x.FinalGrade == null))
            .Select(g => g.Key);
    }
